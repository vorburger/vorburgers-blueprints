...
public class SampleFormView extends CustomComponent {
	...
	SomeBeanService service;
	
	private SomeBean model;
	...
	public SampleFormView() {
		...
		// User code here
		button_save.addListener(new ClickListener() {
			@Override
	...
	public void init() {
		model = service.get(1); // Better put this in init() instead of Constructor, to pool View objects?
		updateViewFromModel();
	}
	
	private void updateViewFromModel() {
		textField_name.setValue(model.name);
		textField_amount.setValue(model.amount);
	}

	private void updateModelFromView() {
		model.name = (String) textField_name.getValue();
		model.amount = (Double) textField_amount.getValue();
	}
