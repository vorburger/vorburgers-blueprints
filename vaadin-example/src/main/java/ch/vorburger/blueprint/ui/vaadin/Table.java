...
public class Table<T> extends com.vaadin.ui.Table {
	...
	public Table() {
		...
		// TODO always? ideally from the outside, if an onClick Event Handler is set on this Table... hm.
		setSelectable(true);
		setImmediate(true);
	}
	...
	// TODO is there any way to write this better, and avoid the Class - somehow with TypeLiteral may be?!
